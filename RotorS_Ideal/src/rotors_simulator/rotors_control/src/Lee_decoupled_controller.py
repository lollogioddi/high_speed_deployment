...
class LeeControl:
    ...
    def __init__(self):
        try:
            ...
            # parameters for checking attitude stabilization and turn on the position control
    ...
    def control_loop(self, allocation_matrix):
         while not rospy.is_shutdown():
            ...
            try:
                ...
                # the aim is to check the stabilization of the drones attitude to activate the position control. 
