...
class LeeControl:
    ...
    def __init__(self):
        try:
            ...
            # parameters for checkinf attitude stabilization and turn on the position control
    ...
    def read_ros_params(self):
        try:
            ...
            # let's normalize the gains value wrt the inertia
    ...
    def control_loop(self, allocation_matrix):
         while not rospy.is_shutdown():
            ...
            try:
                ...
                # Decoupling of position and attitude three conditions here. 
                # the aim is to cehck the stabilization of the drones attitude to activate the position control. 
                # before that, the desired vertical acceleration is a constant fixed value (-10.4581).
                # After that, the position controller is turned on and the compiuted acceleration is used
