#!/usr/bin/env python2
# this controller implements the control strategy presented here: 
# Exponential stability of an attitude tracking control system on SO(3) for large-angle rotational maneuvers
# it's the evolution of the Lee position controller
...
class LeeControl:
    ...
    def read_ros_params(self):
        try:
            ...
            # PID gains
            k_pos = rospy.get_param('~position_gain_Lee')
            k_vel = rospy.get_param('~velocity_gain_Lee')
    ...
    def control_loop(self, allocation_matrix):
         while not rospy.is_shutdown():
            ...
            try:
                ...
                # position control computes desired acceleration 
