...
class LeeControl:
    ...
    def append_string_to_file(self, file_name, value1, value2):
        # Generate a file of two columns with the input values
        path = "/home/lollogioddi/error_file/phi/"
        full_path = path + file_name
        with open(full_path, 'a') as file:
            file.write("{}\t{}\n".format(value1, value2))
    
    def append2_string_to_file(self, file_name, value1, value2, value3, value4):
        # Generate a file of two columns with the input values
        path = "/home/lollogioddi/error_file/rotor_vel/"
        full_path = path + file_name
        with open(full_path, 'a') as file:
    ...
    def control_loop(self, allocation_matrix):
         while not rospy.is_shutdown():
            ...
            try:
                ...
                # desired acceleration computed by the position control
                ...
                # desired angular acceleration computed by the attitude control
